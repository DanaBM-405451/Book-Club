...
function LoginContent() {
  ...
  // ✅ 1. Capturamos la URL de retorno (o usamos dashboard por defecto)
        ...
        <div className="card-vintage">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-neutral-600 font-ui">
              ¿No tienes cuenta?{' '}
              {/* Pasamos el returnUrl al registro también para no perderlo */}
              <Link
...
// ✅ Wrapper con Suspense requerido por useSearchParams en Next.js 13+
